    ...
    return (
        <section className="relative z-20 bg-transparent py-32 px-6 md:px-12">
            <div className="max-w-7xl mx-auto">
                <div className="mb-16">
                    <h2 className="text-4xl md:text-7xl font-bold text-[#dae2fd] tracking-tight uppercase">
                        Technical <span className="text-[#89ceff]">Arsenal</span>
                    </h2>
                    <p className="max-w-xl text-[#dae2fd]/50 font-medium mt-4">
